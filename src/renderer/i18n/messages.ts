...
export const messages = {
  'zh-CN': {
    ...
    'sync.backupCodeRestore': '恢复默认密钥',
    'sync.backupCodeRestoreConfirm':
      '恢复默认密钥会修改当前密钥，使用旧密钥加密的备份可能无法恢复。确定继续吗？',
    'sync.backupCodeRestoreTitle': '恢复默认密钥',
    'sync.backupCodeRequired': '请先保存 Backup Code',
    'sync.backupCreated': '备份已创建',
    'sync.backupDate': '备份日期',
    'sync.backupDevice': '备份设备',
    'sync.backupNow': '立即备份',
    'sync.backups': '已备份记录',
    'sync.apply': '下载并应用',
    ...
    'sync.enabled': '启用云同步',
    'sync.forcePathStyle': '强制 Path Style',
    'sync.group.operations': '同步操作',
    'sync.group.security': '安全设置',
    'sync.group.storage': '存储配置',
    'sync.lastSync': '上次同步：{time}',
    'sync.lastSyncNever': '尚未同步',
    'sync.loadingBackups': '正在加载备份记录…',
    'sync.notConfigured': '请先完成云同步设置，再创建和查看备份。',
    'sync.openSettings': '云同步设置',
    'sync.provider': '存储类型',
    ...
    'sync.saved': '云同步配置已保存',
    'sync.settingsTitle': '云同步设置',
    'sync.showBackupCode': '显示 Backup Code',
    'sync.hideBackupCode': '隐藏 Backup Code',
    'sync.status.error': '失败',
    ...
    'sync.tested': '连接成功',
    'sync.title': '云同步',
    'sync.unknownDevice': '未知设备',
    'sync.webdav.basePath': '路径',
  ...
  'en-US': {
    ...
    'sync.backupCodeRegenerate': 'Regenerate',
    'sync.backupCodeRegenerateConfirm':
      'Regenerating makes backups encrypted with the old Backup Code unreadable. Continue?',
    'sync.backupCodeRestore': 'Restore default key',
    'sync.backupCodeRestoreConfirm':
      'Restoring the default key changes the current key. Backups encrypted with the old key may no longer be recoverable. Continue?',
    'sync.backupCodeRestoreTitle': 'Restore default key',
    'sync.backupCodeRequired': 'Save a Backup Code first',
    'sync.backupCreated': 'Backup created',
    'sync.backupDate': 'Backup date',
    'sync.backupDevice': 'Backup device',
    'sync.backupNow': 'Back up now',
    'sync.backups': 'Backups',
    'sync.apply': 'Download and apply',
    'sync.applyConfirm':
      'Download and apply the backup created on {date} by {device}? Existing records on this device will be kept and merged.',
    'sync.applyTitle': 'Apply backup',
    'sync.applied': 'Backup applied',
    'sync.copied': 'Copied',
    'sync.copyBackupCode': 'Copy Backup Code',
    'sync.delete': 'Delete backup',
    'sync.deleteConfirm':
      'Permanently delete the remote backup created on {date} by {device}? This cannot be undone.',
    'sync.deleteTitle': 'Delete backup',
    'sync.deleted': 'Backup deleted',
    'sync.emptyBackups': 'No remote backups yet',
    'sync.enabled': 'Enable cloud sync',
    'sync.forcePathStyle': 'Force path style',
    'sync.group.operations': 'Sync actions',
    'sync.group.security': 'Security',
    'sync.group.storage': 'Storage',
    ...
    'sync.restoreConfirm':
      'Merge the selected remote backup into this device? Existing records are kept and combined.',
    'sync.restoreSelected': 'Restore selected backup',
    'sync.s3.accessKey': 'Access Key ID',
    'sync.s3.bucket': 'Bucket',
    'sync.s3.endpoint': 'Endpoint',
    'sync.s3.prefix': 'Path prefix',
    'sync.s3.region': 'Region',
    'sync.s3.secretKey': 'Secret Access Key',
    'sync.saved': 'Cloud sync settings saved',
    'sync.settingsTitle': 'Cloud sync settings',
    'sync.showBackupCode': 'Show Backup Code',
    'sync.hideBackupCode': 'Hide Backup Code',
    'sync.status.error': 'Failed',
    'sync.status.success': 'Succeeded',
    'sync.syncNow': 'Sync now',
    'sync.synced': 'Sync completed',
    'sync.test': 'Test connection',
    'sync.tested': 'Connection succeeded',
    'sync.title': 'Cloud sync',
    'sync.unknownDevice': 'Unknown device',
    'sync.webdav.basePath': 'Base path',
