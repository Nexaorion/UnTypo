...
import { ProviderContractError, type UserProfileContext } from '../../core/providers/types.js';
import type {
...
import type { DictionarySuggestionError } from '../../shared/overlay-ipc.js';
import { CapsuleWindowController } from '../status-overlay/overlay-window.js';
...
import { DictionaryLearningService } from '../dictionary/auto-learn.js';
import { WritingPreferenceLearningService } from '../personalization/style-learner.js';
import { ElectronClipboardAdapter } from '../dictation/electron-clipboard.js';
import { HotkeyManager } from '../hotkey/hotkey-manager.js';
import type { ClientBackendPort } from '../ipc/handler.js';
import { createLoginItemSettings } from '../platform/login-item.js';
import {
  NativeHelperClient,
...
import { ConfigurationService, DictionaryEntryError } from '../storage/config-store.js';
import type { ProviderProfile } from '../storage/config-store.js';
import { ElectronSecretProtector } from '../storage/keychain.js';
import { HistoryRepository, HistoryService } from '../storage/history.js';
import { applyTelemetryEnabled } from '../telemetry/crash-reporter.js';
import { SyncService } from '../sync/sync-service.js';
import { ApplicationUpdateService } from '../update/auto-updater.js';
import { SelectionWindowController } from '../selection/selection-window.js';
import { runSelectionSmokeTest } from '../testing/selection-smoke.js';
import { TrayController } from '../tray/tray-controller.js';
import { buildClientSnapshot } from './snapshot-builder.js';
import { mergeSettingsUpdate } from './settings-merger.js';
