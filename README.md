...
<p align="center">
  <img src="https://img.shields.io/badge/status-0.1.10%20early-f4f4f5?style=flat-square&labelColor=18181b" alt="0.1.10 early">
...
- 在任意应用里用快捷键开始听写；
- 设置口述语言和默认翻译目标语言；
- 模型会把口述内容按普通转写、翻译请求或内容指令等模式进行处理，普通转写会输入到原来的光标位置，翻译与指令结果会自动显示在浮窗中。
